...
import com.md.entity.bo.AddCategory;
...
public class CategoriesApplication {
    ...
    public Result addCategories(@RequestBody AddCategory addCategory) throws Exception {
        Category categories = categoryService.addCategories(addCategory.getCat_pid(), addCategory.getCat_name(),
                addCategory.getCat_level());
        meta.setStatus(201);
